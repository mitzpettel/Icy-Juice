...
namespace ICQ2000 {
  ...
  const unsigned short SNAC_MSG_TypingIndicator = 0x0014;
  ...
  class TypingIndicatorSNAC : public MsgFamilySNAC, public OutSNAC, public InSNAC {
   private:
    unsigned int m_uin;
   ...
   public:
    TypingIndicatorSNAC( unsigned int uin=0, unsigned short flags=0 );
    
    unsigned int getUIN() { return m_uin; }
    unsigned short getFlags() { return m_flags; }
    
    unsigned short Subtype() const { return SNAC_MSG_TypingIndicator; }
  };
