...
*/
  ...
  string FileTransferEvent::getCurrFilename() const
  {
    return m_currfilename;
  }

  void FileTransferEvent::setCurrFilename(const std::string& name)
  {
    m_currfilename = name;
  }
  ...
  FileTransferClient* FileTransferEvent::getFileTransferClient()
  {
    return m_ftc;
  }
  
  void FileTransferEvent::setFileTransferClient( FileTransferClient *ftc )
  {
    m_ftc = ftc;
  }
  ...
  TypingIndicatorEvent::TypingIndicatorEvent(ContactRef c, unsigned short flags)
   : ICQMessageEvent(c), m_flags(flags) { }

  MessageEvent::MessageType TypingIndicatorEvent::getType() const { return MessageEvent::TypingIndicator; }

  unsigned int TypingIndicatorEvent::getSenderUIN() const { return m_contact->getUIN(); }
  
  unsigned short TypingIndicatorEvent::getFlags() const { return m_flags; }

  ICQMessageEvent* TypingIndicatorEvent::copy() const
  {
    return new TypingIndicatorEvent(*this);
  }
