...
namespace ICQ2000
{
  ...
  void MessageHandler::handleWantFile(FileTransferEvent *ev, std::ios *stream)
  {
    filetransfer_want_file_signal.emit(ev, stream);
  }
  ...
  ICQMessageEvent* MessageHandler::UINICQSubTypeToEvent(UINICQSubType *st, const ContactRef& contact)
  {
    ...
    case MSG_Type_Normal:
    {
      ...
      e = new NormalMessageEvent(contact,
				 ...
				 nst->isMultiParty(), nst->getTextEncoding() );
      break;
    }
