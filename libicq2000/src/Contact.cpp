...
namespace ICQ2000 {
  ...
  unsigned short Contact::getTypingFlags() const { return m_typing_flags; }
  ...
  void Contact::setTypingFlags(unsigned short flags)
  {
   if ( m_typing_flags!=flags )
   {
    m_typing_flags = flags;
    
    StatusChangeEvent sev(this, m_status, m_status);
