...
namespace ICQ2000 {
  ...
  class UserAddedEvent : public UserContactListEvent {
   public:
    ...
    UserAddedEvent(const ContactRef& c);
  ...
  class UserRemovedEvent : public UserContactListEvent {
   public:
    ...
    UserRemovedEvent(const ContactRef& c);
    EventType getType() const;
  };
...
//    unsigned int getFilesInQueue();
    ...
    void setCurrFilename(const std::string& name);
    ...
    FileTransferClient *getFileTransferClient();
    void setFileTransferClient( FileTransferClient *ftc );
   ...
   */
  class TypingIndicatorEvent : public ICQMessageEvent {
   private:
    unsigned short m_flags;
    
   public:
    TypingIndicatorEvent(ContactRef c, unsigned short flags);
