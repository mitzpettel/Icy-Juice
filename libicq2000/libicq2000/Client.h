...
namespace ICQ2000
{
  ...
  class Client : public sigslot::has_slots<>
  {
   private:
    ...
    struct timeval m_transmission_times[80];
    int m_transmission_times_index;
    ...
    void SignalTypingIndicator(TypingIndicatorSNAC *snac);
   ...
   public:
    ...
    /**
     *  Signal when a FileTransferEvent needs file access. The client
     *  should setSize and setCurrFilename based on getCurrentFile
     *  and prepare the stream for access.
     */
    sigslot::signal2<FileTransferEvent*, std::ios*> filetransfer_want_file_signal;
    ...
    void FileTransferSkipFile(FileTransferEvent *ev);
    ...
    void fetchDetailContactInfo(const ContactList& l);
